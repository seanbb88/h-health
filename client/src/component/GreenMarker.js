...
function GreenMarker(props) {
    return (
        <div className="dropup">
            <span class="fas fa-map-marker-alt green-marker dropdown-toggle marker-button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-hidden="true">
            </span>
